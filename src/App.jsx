  ...
  return (
    ...
    <img className='fixed -z-10 h-[785px] opacity-50' src={bgpic} alt="" />
      <div className="moveup lg:fixed text-green-400 p-10 bg-[#fff0db] bg-opacity-40 h-[100%]">
        <p className='text-6xl md:text-8xl font-bold mt-32'>GameNote</p>
